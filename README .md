...
Handling Missing Values: Identified and removed rows with empty Total Charges.
...
One-Hot Encoding: Transformed multi-category features like Payment Method and Contract into dummy variables.

Skewness Correction: Applied a Square Root Transformation to Total Charges to normalize its distribution.
